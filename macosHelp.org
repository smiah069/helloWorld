...
a. Insert the bootable USB and restart.  While restarting, press option key until you get macOS recovery window
a. Choose Install/reinstall macOS and follow the on-screen instructions. 
...
a. Choose "Macintosh HD - Data" and then click "Erase"
a. Choose "Macintosh HD" then click "Erase"
a. Cmd + q  to quit the Disk Utility window
a. Now choose "Install macOS" and follow the on-screen instructions to complete installation. 
